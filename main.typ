...
This approach worked reasonablely well, as it was able to prove 36.6% of the theroems in the MiniF2F test benchmark @MINIF2F . However, it used LeanStep for data extraction and contributed lean-gym for data training, respectively. These two frameworks have since gone unmaintained.
